	...
	(function ($) {
	  ...
	  */
		...
		$.fn.extend({
			...
			toScroll: function toScroll(cfg) {
			...
			toCheckbox: function toCheckbox(cfg) {
			...
			toSelect: function toSelect(cfg) {
